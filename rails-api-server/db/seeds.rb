...
users = User.create([
  ...
  { name: 'Guy', email: 'ggwass@gmail.com', contact: '222-222-2222', profile_pic: 'http://res.cloudinary.com/rainmire/image/upload/c_lfill,h_300,w_300/v1513199891/dog2_rz2qbr.jpg' },
